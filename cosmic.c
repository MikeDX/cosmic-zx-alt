...
void clrscr() {
  ...
  memset(vidattrs, 0x7, 0x300); // set attributes
}
...
{3,16,/*{w:24,h:16,bpp:1,brev:1}*/0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3C,0x00,0x00,0x7E,0x00,0x03,0xFF,0xC0,0x0F,0xFF,0xF0,0x1F,0xFF,0xF8,0x3F,0xFF,0xFC,0x3F,0xFF,0xFC,0x3F,0xFF,0xFC,0x3F,0xFF,0xFC,0x3F,0xFF,0xFC,0x3F,0xFF,0xFC};
const byte bomb_bitmap[] =
{1,5,/*{w:8,h:5,bpp:1,brev:1}*/0x08,0x04,0x08,0x10,0x08};
const byte bullet_bitmap[] =
{1,5,/*{w:8,h:5,bpp:1,brev:1}*/0x18,0x18,0x18,0x18,0x18};
const byte enemy1_bitmap[] =
{2,16,/*{w:16,h:16,bpp:1,brev:1}*/0x00,0x00,0x08,0x08,0x04,0x10,0x03,0xE0,0x1F,0xFC,0x2D,0xDA,0x2F,0xFA,0x2F,0xFA,0x0F,0xF8,0x08,0x08,0x06,0x30,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
const byte enemy2_bitmap[] =
{2,16,/*{w:16,h:16,bpp:1,brev:1}*/0x00,0x00,0x00,0x00,0x01,0x00,0x03,0x80,0x07,0xC0,0x07,0xC0,0x0B,0xA0,0x0F,0xE0,0x0F,0xE0,0x02,0x80,0x05,0x40,0x08,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
const byte enemy3_bitmap[] =
{2,16,/*{w:16,h:16,bpp:1,brev:1}*/0x00,0x00,0x00,0x00,0x00,0x00,0x07,0xF0,0x0F,0xF8,0x1D,0xDC,0x1D,0xDC,0x1F,0xFC,0x1F,0xFC,0x0F,0xF8,0x02,0x20,0x0C,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
...
void draw_playfield() {
  ...
  for (i=0; i<VBWIDTH-2; i++)
    vidmem[191][i] = 0x55;
  draw_bunker(20, 165, 15, 2, 10);
  draw_bunker(70, 165, 15, 2, 10);
  draw_bunker(120, 165, 15, 2, 10);
  draw_bunker(170, 165, 15, 2 , 10);
}
